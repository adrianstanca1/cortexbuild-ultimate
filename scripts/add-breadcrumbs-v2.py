#!/usr/bin/env python3
"""
Add breadcrumbs to all CortexBuild modules - Fixed version
Properly handles JSX structure
"""
...
def add_breadcrumbs(filepath: Path, module_name: str) -> bool:
    try:
        ...
        # 2. Add breadcrumbs - find "return (" followed by newline and whitespace and "<div"
        # Replace just the div tag, not the return
        pattern = r"(return\s*\(\s*\n)(\s+)(<div[^>]*>)"
        
        replacement = f'\\1\\2<ModuleBreadcrumbs currentModule="{module_name}" onNavigate={{() => {{}}}} />\n\\2\\3'
