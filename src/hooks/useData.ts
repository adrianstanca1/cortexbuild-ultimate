...
export const useChangeOrders   = makeHooks('change_orders',  changeOrdersApi);
...
export const useDailyReports   = makeHooks('daily_reports',  dailyReportsApi);
export const useMeetings       = makeHooks('meetings',       meetingsApi);
export const useMaterials      = makeHooks('materials',      materialsApi);
export const usePunchList      = makeHooks('punch_list',     punchListApi);
