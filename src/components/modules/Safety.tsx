...
export function Safety() {
  ...
  const { data: raw = [], isLoading, error, refetch } = useList();
        ...
        <div className="space-y-6">
          ...
          {error && (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-gray-400 text-sm mb-4">{String(error)}</p>
              <button onClick={() => refetch()} className="px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm rounded-lg flex items-center gap-2">
          ...
          {!isLoading && !error && filtered.length === 0 && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <h3 className="text-white font-semibold text-base mb-1">No incidents recorded</h3>
              <p className="text-gray-400 text-sm mb-4">Start by creating your first safety incident or near-miss report.</p>
              <button onClick={() => { setForm(defaultForm); setEditId(null); setShowModal(true); }} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors flex items-center gap-2">
