...
// This prevents the entire <MobileTimesheet> and its children from needlessly re-rendering every second.
function MobileTimesheetClock({ clockedIn, clockInTime }: { clockedIn: boolean; clockInTime: Date | null }) {
    ...
    <div className="p-4 max-w-lg mx-auto space-y-4">
      ...
      <div className="bg-gradient-to-br from-indigo-900 to-indigo-800 rounded-2xl p-5 text-center border border-indigo-700">
        ...
        <div className="text-5xl font-bold text-indigo-100 font-mono tracking-wider my-3">
          <MobileTimesheetClock clockedIn={clockedIn} clockInTime={clockInTime} />
        </div>
